...
newMaster = input("Please enter a new master password: ")

strNewHash = hashlib.sha256(newMaster.encode()).hexdigest()
strEncryptedHash = fnEncryptString(strNewHash, newMaster)

print(f"The new encrypted master password is {newMaster}, here is the encrypted form: \n{strEncryptedHash}")